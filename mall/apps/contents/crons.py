...
#     channels = GoodsChannel.objects.order_by('group_id', 'squence')
...
#                                                          'url': channel.url})
#         for one in channel.category.goodscategory_set.all():
#             one.sub_cats = []
#             for two in one:
#                 one.sub_cats.append(two)
#             categories[channel.group_id]['sub_cats'].append(one)
#
#     contents = {}
#     content_categories = ContentCategory.objects.all()
#     for cat in content_categories:
#         contents[cat.key] = cat.content_set.filter(status=True).order_by('squence')
#
#     context = {
